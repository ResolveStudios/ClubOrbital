Shader "Hidden/Locked/.poiyomi/★ Poiyomi Pro ★/FloorLogo-FloorLogo"
{
    Properties
    {
...
#define PROPM_START_DECAL0AUDIOLINK 1
#define PROP_AUDIOLINKDECAL0SCALEBAND 1
...
#define PROP_AUDIOLINKDEBUGLOWMID 1
#define PROP_AUDIOLINKDEBUGBASS 1
