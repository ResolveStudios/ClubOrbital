Shader "Hidden/Locked/.poiyomi/★ Poiyomi Pro ★/HolographicGlass-HolographicGlass"
{
    Properties
    {
...
#define PROP_BRDFMETALLIC 0.697
#define PROP_BRDFGLOSSINESS 1
#define PROP_BRDFREFLECTANCE 1
#define PROP_BRDFANISOTROPY 0.064
...
#define PROP_ENABLEHOLO 1
#define PROP_HOLOALPHAMAP
#define PROP_HOLOCOORDINATESPACE 0
#define PROP_HOLOLINEDENSITY 0.2
#define PROP_HOLOSCROLLSPEED 5
#define PROPM_START_FRESNELALPHA 1
#define PROP_HOLOFRESNELALPHA 0.537
#define PROP_HOLORIMSHARPNESS 0
#define PROP_HOLORIMWIDTH 0
