...
half4 fragShadowCaster(
    ...
    ): SV_Target
    {
        ...
        poiMesh.uv[2] = i.uv2;
        poiMesh.uv[3] = i.uv3;
        float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, TRANSFORM_TEX(poiMesh.uv[float(0)], _MainTex) + _Time.x * float4(5,0,0,0));
        ...
        poiCam.worldPos = _WorldSpaceCameraPos;
            ...
            alpha.a *= alphaMask;
            alpha.a *= float4(0.01764195,0.02217388,0.02217388,1).a + .0001;
            alpha.a += float(0);
