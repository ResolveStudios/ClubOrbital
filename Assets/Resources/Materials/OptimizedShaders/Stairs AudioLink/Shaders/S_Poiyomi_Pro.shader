Shader "Hidden/Locked/.poiyomi/★ Poiyomi Pro ★/Stairs AudioLink-Stairs AudioLink"
{
    Properties
    {
...
#define PROP_EMISSIVEBLINK_MAX 0.5
...
#define PROP_EMISSIVEBLINK_MAX1 0.5
#define PROP_EMISSIVEBLINK_VELOCITY1 3
