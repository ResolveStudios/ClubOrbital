Shader "Hidden/Locked/.poiyomi/★ Poiyomi Pro ★/TubeLight-TubeLight"
{
    Properties
    {
...
#define PROPM_START_RIMAUDIOLINK 1
#define PROP_AUDIOLINKRIMWIDTHBAND 0
#define PROP_AUDIOLINKRIMEMISSIONBAND 0
#define PROP_AUDIOLINKRIMBRIGHTNESSBAND 2
